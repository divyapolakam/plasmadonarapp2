...
def check(email):
    url =  "https://q23de35bn5.execute-api.us-east-2.amazonaws.com/plasma/getdata?email="+email
...
def register():
    ...
    if('errorType' in check(x[1])):
        url = "https://q23de35bn5.execute-api.us-east-2.amazonaws.com/plasma/registration?"+params
...
def requested():
    ...
    #print(bloodgrp)
    url = "https://q23de35bn5.execute-api.us-east-2.amazonaws.com/plasma/requestonbloodgroup?blood="+bloodgrp
    status = requests.request("GET",url)
    a=status.json()
    print(a)
    phone=[]
    for i in a:
        url="https://www.fast2sms.com/dev/bulk?authorization=s96T01PuJnmXwCNMeaUI4fAzvxlDR2jW7pVydLkt8bOhrG5Ecgjs89QYB2IWDqkpERv1blaOiezom5CA&sender_id=FSTSMS&message=Need of plasma of your blood group&language=english&route=p&numbers="+str(i['phone'])
